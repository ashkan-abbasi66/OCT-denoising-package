...
sigma     = 27;      % Noise standard deviation. it should be in the same 
...
%%
figure,imshow(y_est(:,:,1)/255)
gt = double(imread('./oct_data/average.tif'));
comp_psnr(gt,y_est(:,:,1))
% 28
% Total execution time: 19.5 sec 
% ans =
%   single
%    23.4469

% sigma = -1
% Total execution time: 21.6 sec 
% time =
%    21.8875
% ans =
%   single
