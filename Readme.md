...
✓ To use one of our proposed mixed multiscale BM4D (mmBM4D) methods, just set either of `MS_BM4D_dwt3`, `MS_BM4D_dwt3_log`, `MS_BM4D_dualtree3`, or `MS_BM4D_dualtree3_log` to 1 in `Run_benchmarks_dt1.m`.
